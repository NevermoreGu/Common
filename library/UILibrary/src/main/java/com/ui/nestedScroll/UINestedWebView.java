...
public class UINestedWebView extends UIWebView implements NestedScrollingChild {
    ...
    public UINestedWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public UINestedWebView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                // mLastTouchY record is always relative to UINestedWehView
