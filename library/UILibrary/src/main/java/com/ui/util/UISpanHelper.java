...
import com.ui.span.UIAlignMiddleImageSpan;
import com.ui.span.UIMarginImageSpan;
...
public class UISpanHelper {
    ...
    public static CharSequence generateHorIconText(CharSequence text, int leftPadding, Drawable iconLeft, int rightPadding, Drawable iconRight, int iconOffsetY) {
        ...
        if (iconLeft != null) {
            ...
            UIMarginImageSpan imageSpan = new UIMarginImageSpan(iconLeft, UIAlignMiddleImageSpan.ALIGN_MIDDLE, 0, leftPadding, iconOffsetY);
        ...
        if (iconRight != null) {
            ...
            UIMarginImageSpan imageSpan = new UIMarginImageSpan(iconRight, UIAlignMiddleImageSpan.ALIGN_MIDDLE, rightPadding, 0, iconOffsetY);
            imageSpan.setAvoidSuperChangeFontMetrics(true);
            builder.setSpan(imageSpan, start, end, Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
        }
