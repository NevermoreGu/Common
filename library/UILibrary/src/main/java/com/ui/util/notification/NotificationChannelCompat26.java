...
public class NotificationChannelCompat26 {
    ...
    private String NIM_CHANNEL_ID;
    private String NIM_CHANNEL_NAME;
    private String NIM_CHANNEL_DESC;


    public NotificationChannelCompat26(String NIM_CHANNEL_ID, String NIM_CHANNEL_NAME, String NIM_CHANNEL_DESC) {
        this.NIM_CHANNEL_ID = NIM_CHANNEL_ID;
        this.NIM_CHANNEL_NAME = NIM_CHANNEL_NAME;
        this.NIM_CHANNEL_DESC = NIM_CHANNEL_DESC;
    }

    public String getNIMChannelId(Context context) {
        /*
    ...
    private NotificationChannel buildNIMMessageChannel() {
