...
import com.ui.widget.INotchInsetConsumer;
import com.ui.widget.IWindowInsetLayout;
...
public class UIWindowInsetHelper {
    ...
    public UIWindowInsetHelper(ViewGroup viewGroup, IWindowInsetLayout windowInsetLayout) {
        ...
        KEYBOARD_HEIGHT_BOUNDARY = UIDisplayHelper.dp2px(viewGroup.getContext(), 100);
