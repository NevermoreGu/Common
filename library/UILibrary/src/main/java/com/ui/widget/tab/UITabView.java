...
public class UITabView extends FrameLayout {
        ...
        if (hasRedPoint || hasSignCount) {
            ...
            if (hasSignCount) {
                ...
                mSignCountView.setMinWidth(UIResHelper.getAttrDimen(getContext(),
                        R.attr.ui_tab_sign_count_view_minSize_with_text));
                ...
                int redPointSize = UIResHelper.getAttrDimen(getContext(),
                        R.attr.ui_tab_sign_count_view_minSize);
    ...
    public void setSelectFraction(float fraction) {
        ...
        if (tabIcon != null) {
            tabIcon.setSelectFraction(fraction,
                    UIColorHelper.computeColor(mTab.normalColor, mTab.selectedColor, fraction));
        }
    ...
    protected TextView createSignCountView(Context context) {
        return new TextView(context, null, R.attr.ui_tab_sign_count_view);
    }
