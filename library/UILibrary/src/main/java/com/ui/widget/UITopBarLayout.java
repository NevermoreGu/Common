...
public class UITopBarLayout extends FrameLayout {
    ...
    public UITopBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.UITopBar, R.attr.UITopBarStyle, 0);
        ...
        LayoutParams lp = new LayoutParams(
                ...
                UIResHelper.getAttrDimen(context, R.attr.ui_topbar_height));
        addView(mTopBar, lp);
