...
import com.ui.R;
import com.ui.alpha.UIAlphaLinearLayout;


/**
 * UIBottomSheet 的ItemView
 * @author zander
 * @date 2017-12-05
 */
public class UIBottomSheetItemView extends UIAlphaLinearLayout {
    ...
    public UIBottomSheetItemView(Context context) {
        super(context);
    }

    public UIBottomSheetItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public UIBottomSheetItemView(Context context, AttributeSet attrs, int defStyleAttr) {
