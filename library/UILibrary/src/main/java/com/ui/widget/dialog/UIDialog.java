...
public class UIDialog extends Dialog {
    ...
    public static class MessageDialogBuilder extends UIDialogBuilder<MessageDialogBuilder> {
        ...
        private UIWrapContentScrollView mScrollContainer;
        ...
        protected void onCreateContent(UIDialog dialog, ViewGroup parent, Context context) {
            if (mMessage != null && mMessage.length() != 0) {
                ...
                assignMessageTvWithAttr(mTextView, hasTitle(), R.attr.ui_dialog_message_content_style);
                mTextView.setText(mMessage);
                mTextView.setMovementMethodDefault();


                mScrollContainer = new UIWrapContentScrollView(context);
    ...
    public static class CheckBoxMessageDialogBuilder extends UIDialogBuilder<CheckBoxMessageDialogBuilder> {
        ...
        public CheckBoxMessageDialogBuilder(Context context) {
            super(context);
            mCheckMarkDrawable = UIResHelper.getAttrDrawable(context, R.attr.ui_s_checkbox);
        }
    ...
    public static class EditTextDialogBuilder extends UIDialogBuilder<EditTextDialogBuilder> {
        ...
        protected void onCreateContent(UIDialog dialog, ViewGroup parent, Context context) {
            ...
            mMainLayout.setBackgroundResource(R.drawable.ui_edit_bg_border_bottom);
            ...
            mEditText.setPadding(0, 0, 0, UIDisplayHelper.dpToPx(5));
        ...
        protected RelativeLayout.LayoutParams createRightIconLayoutParams() {
            ...
            rightIconLp.leftMargin = UIDisplayHelper.dpToPx(5);
            return rightIconLp;
        }
    ...
    public static class MenuBaseDialogBuilder<T extends UIDialogBuilder> extends UIDialogBuilder<T> {
        ...
        protected UIWrapContentScrollView mContentScrollView;
        ...
        protected void onCreateContent(UIDialog dialog, ViewGroup parent, Context context) {
            ...
            TypedArray a = context.obtainStyledAttributes(null, R.styleable.UIDialogMenuContainerStyleDef, R.attr.ui_dialog_menu_container_style, 0);
            int count = a.getIndexCount();
            ...
            mContentScrollView = new UIWrapContentScrollView(context);
    ...
    public static class MultiCheckableDialogBuilder extends MenuBaseDialogBuilder<MultiCheckableDialogBuilder> {
        ...
        @Override
        public MultiCheckableDialogBuilder addItem(UIDialogMenuItemView itemView, OnClickListener listener) {
    ...
    public static abstract class AutoResizeDialogBuilder extends UIDialogBuilder {
        ...
        public abstract View onBuildContent(UIDialog dialog, ScrollView parent);
        ...
        private void bindEvent(final Context context) {
            ...
            mRootView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                public void onGlobalLayout() {
                    ...
                    mScreenHeight = UIDisplayHelper.getScreenHeight(context);
