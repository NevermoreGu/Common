...
public class UIBottomSheet extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int screenWidth = UIDisplayHelper.getScreenWidth(getContext());
        int screenHeight = UIDisplayHelper.getScreenHeight(getContext());
    ...
    public static class BottomListSheetBuilder {
        ...
        public UIBottomSheet build() {
            mDialog = new UIBottomSheet(mContext);
        ...
        private boolean needToScroll() {
            int itemHeight = UIResHelper.getAttrDimen(mContext, R.attr.ui_bottom_sheet_list_item_height);
            ...
            if (mTitleTv != null && !UILangHelper.isNullOrEmpty(mTitle)) {
                totalHeight += UIResHelper.getAttrDimen(mContext, R.attr.ui_bottom_sheet_title_height);
            }
        ...
        protected int getListMaxHeight() {
            return (int) (UIDisplayHelper.getScreenHeight(mContext) * 0.5);
        }
        ...
        protected int getContentViewLayoutId() {
            return R.layout.ui_bottom_sheet_list;
        }
        ...
        private class ListAdapter extends BaseAdapter {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    convertView = inflater.inflate(R.layout.ui_bottom_sheet_list_item, parent, false);
    ...
    public static class BottomGridSheetBuilder implements View.OnClickListener {
        ...
        public BottomGridSheetBuilder addItem(int imageRes, CharSequence text, Object tag, @Style int style, int subscriptRes) {
            UIBottomSheetItemView itemView = createItemView(AppCompatResources.getDrawable(mContext, imageRes), text, tag, subscriptRes);
        ...
        public UIBottomSheetItemView createItemView(Drawable drawable, CharSequence text, Object tag, int subscriptRes) {
            LayoutInflater inflater = LayoutInflater.from(mContext);
            UIBottomSheetItemView itemView = (UIBottomSheetItemView) inflater.inflate(getItemViewLayoutId(), null, false);
        ...
        private View buildViews() {
            ...
            int screenWidth = UIDisplayHelper.getScreenWidth(mContext);
            int screenHeight = UIDisplayHelper.getScreenHeight(mContext);
        ...
        protected int getContentViewLayoutId() {
            return R.layout.ui_bottom_sheet_grid;
        }

        protected int getItemViewLayoutId() {
            return R.layout.ui_bottom_sheet_grid_item;
        }
        ...
        private int calculateItemWidth(int width, int maxItemCountInEachLine, int paddingLeft, int paddingRight) {
            if (mMiniItemWidth == -1) {
                mMiniItemWidth = UIResHelper.getAttrDimen(mContext, R.attr.ui_bottom_sheet_grid_item_mini_width);
            }
