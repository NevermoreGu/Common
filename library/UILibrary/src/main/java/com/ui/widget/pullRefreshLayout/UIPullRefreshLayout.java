...
package com.ui.widget.pullRefreshLayout;
 ...
 * <li>可在 xml 中使用 {@link com.ui.R.styleable#UIPullRefreshLayout} 这些属性或在 Java 设置对应的属性决定子View的开始位置、触发刷新的位置等值</li>
 * </ul>
 *
 * @author cginechen
 * @date 2016-12-11
...
public class UIPullRefreshLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public static class RefreshView extends AppCompatImageView implements IRefreshView {
        ...
        public RefreshView(Context context) {
            ...
            setColorSchemeColors(UIResHelper.getAttrColor(context, R.attr.ui_config_color_blue));
