...
import com.ui.R;
import com.ui.layout.IUILayout;
import com.ui.layout.UIFrameLayout;
 ...
 */
public class UIPopup extends UIBasePopup {
    ...
    public UIPopup(Context context, @Direction int preferredDirection) {
        super(context);
    ...
    public void setContentView(View root) {
        if (root.getBackground() != null) {
            if (root instanceof IUILayout) {
                ((IUILayout) root).setRadius(getRootLayoutRadius(mContext));
            } else {
                UIFrameLayout clipLayout = new UIFrameLayout(mContext);
    ...
    public void setCustomBg(boolean isCustom) {
        this.isCustomBg = isCustom;
    }
    ...
    protected int getRootLayout() {
        return R.layout.ui_popup_layout;
    }

    protected int getRootLayoutRadius(Context context) {
        return UIDisplayHelper.dp2px(context, 5);
    }
