...
import com.ui.util.UICollapsingTextHelper;
import com.ui.util.UILangHelper;
import com.ui.util.UIViewHelper;
import com.ui.util.UIViewOffsetHelper;
...
public class UICollapsingTopBarLayout extends FrameLayout implements IWindowInsetLayout {
    ...
    public UICollapsingTopBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setContentScrim(a.getDrawable(R.styleable.UICollapsingTopBarLayout_ui_contentScrim));
        setStatusBarScrim(a.getDrawable(R.styleable.UICollapsingTopBarLayout_ui_statusBarScrim));
...
//            mTmpRect.top = mTmpRect.top - topBarInsetAdjustTop;
    ...
    /**
     * if in onLayout, the child.getTop is precise， but UIViewOffsetHelper.onViewLayout may not called,
                ...
                switch (lp.mCollapseMode) {
                    case LayoutParams.COLLAPSE_MODE_PIN:
                        offsetHelper.setTopAndBottomOffset(
                                UILangHelper.constrain(-verticalOffset, 0, getMaxOffsetForPinChild(child, false)));
                        break;
