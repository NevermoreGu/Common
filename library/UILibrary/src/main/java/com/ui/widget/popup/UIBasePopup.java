 ...
 */
public abstract class UIBasePopup {
    private static final String TAG = "UIBasePopup";
    ...
    protected int makeWidthMeasureSpec(View view) {
        return View.MeasureSpec.makeMeasureSpec(UIDisplayHelper.getScreenWidth(mContext), View.MeasureSpec.AT_MOST);
    }

    protected int makeHeightMeasureSpec(View view) {
        return View.MeasureSpec.makeMeasureSpec(UIDisplayHelper.getScreenHeight(mContext), View.MeasureSpec.AT_MOST);
    }
    ...
    public class RootView extends UIFrameLayout {
        ...
        protected void onConfigurationChanged(Configuration newConfig) {
            ...
            UIBasePopup.this.onConfigurationChanged(newConfig);
        }
